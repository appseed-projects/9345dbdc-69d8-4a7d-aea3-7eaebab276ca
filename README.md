...
> 🚀 Built with [Soft UI Dashboard Generator](https://appseed.us/generator/soft-ui-dashboard/), timestamp `2022-07-15 05:13`
...
```bash
$ # Get the code
$ git clone https://github.com/appseed-projects/9345dbdc-69d8-4a7d-aea3-7eaebab276ca.git
$ cd 9345dbdc-69d8-4a7d-aea3-7eaebab276ca
```
